...
public class Barbaro  extends  Persona implements Proteger, Atacar, Agradecimento {
    public Barbaro(double dano, double vida, double velocidade, double destreza, double defesa, double mana) {
    ...
    public void Obrigado(){
        System.out.println("Meu machado cortará todos ao meio" + "\n");
    }
}
