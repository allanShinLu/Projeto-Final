...
public class Ladino extends Persona implements Proteger, Atacar, Agradecimento{

    public Ladino(double dano, double vida, double velocidade, double destreza, double defesa, double mana) {
    ...
    public void Obrigado(){
        System.out.println("Os assassinos de Konshu estão a dispor" + "\n");
    }
}
