...
public class Paladino extends Persona implements Proteger, Atacar, Agradecimento {
    public Paladino(double dano, double vida, double velocidade, double destreza, double defesa, double mana) {
    ...
    public void Obrigado(){
        System.out.println("Deus nos abençoe" + "\n");
    }
}
